...
public class MTFInterceptor extends MyBaseInterceptor {
    ...
    public MTFInterceptor () {
        super();
        this.excludeList = Arrays.asList(".*process inventory move.*", ".*login user.*");
    ...
    public List<Rule> initializeRules () {
        ...
        rules.add(new Rule.Builder(
                "com.redprairie.mtf.session.CFrameworkSession")
